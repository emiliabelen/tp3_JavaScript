...
function esMayuscula(letra) {
  ...
  document.write('<hr>');
  comprobarMayusMinusAmbas('ME CUESTA MUCHO ENTENDER JAVASCRIPT');
  document.write('<hr>');
  comprobarMayusMinusAmbas('pero vamos a ponerle ONDA');
  document.write('<hr>');
  comprobarMayusMinusAmbas('Por que quiero cambiar de laburo');